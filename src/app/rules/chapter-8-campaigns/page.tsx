...
export async function generateMetadata(): Promise<Metadata> {
  const chapterConfig = getChapterConfig('chapter-8-campaigns');
  if (!chapterConfig) {
    return {
...
export default function Chapter8CampaignsPage() {
  return <ChapterTemplate chapterId="chapter-8-campaigns" />;
} 